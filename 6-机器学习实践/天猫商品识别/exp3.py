...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=[(2000, 400),(2000,600)], keep_ratio=True),
...
# ann_file_test=args.ann_file_test
...
data = dict(
    imgs_per_gpu=2,  #每个计算机分配的图像数量
    workers_per_gpu=2,  #每个gpu分配的线程数
    train=dict(
        type=dataset_type,
        # ann_file='./data3/i_train.json', #数据集annotation路径
        # #img_prefix='./data/image/',  #数据集的图片路径
        # img_prefix='./data3/I/',  #数据集的图片路径
        ann_file=ann_file_train, #数据集annotation路径
        img_prefix=img_spath,  #数据集的图片路径
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        # ann_file='./data3/v_train.json', #数据集annotation路径
        # img_prefix='./data3/V/',  #数据集的图片路径
        ann_file=ann_file_test,
        img_prefix=video_img_spath,
...
work_dir = './expresult/det/'
load_from = './data/cascade_rcnn_r50_fpn_20e_20181123-db483a09.pth'

# work_dir=args.work_dir
# load_from =args.check
